<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager.ascx.cs" Inherits="LucentTechnologies.Controls.Manager" %>
                ...
                <div class="navbar-collapse collapse">
                 ...
                 <!--Doctors-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                                <li><a runat="server"  ><%: "Welcome " + Session["name"] %></a></li>
                                <li>
