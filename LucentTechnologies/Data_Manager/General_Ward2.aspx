<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="General_Ward2.aspx.cs" Inherits="LucentTechnologies.Data_Manager.General_Ward2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     
    <div class="page-header">
        <h3>General Ward Two Registration Form</h3>
    </div>

         <ul class="nav nav-tabs"> 
         <li ><a href="General_Ward1.aspx">General Ward One</a></li>
         <li class="active"><a href="General_Ward2.aspx">General Ward Two</a></li>
