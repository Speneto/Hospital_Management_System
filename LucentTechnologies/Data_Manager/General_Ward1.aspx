<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="General_Ward1.aspx.cs" Inherits="LucentTechnologies.Data_Manager.General_Ward1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

    
    <div class="page-header">
        <h3>General Ward One Registration Form</h3>
    </div>

         <ul class="nav nav-tabs"> 
         <li class="active"><a href="General_Ward1.aspx">General Ward One</a></li>
         <li><a href="General_Ward2.aspx">General Ward Two</a></li>
         <li><a href="VIP_Ward.aspx">VIP Ward</a></li>
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <asp:TextBox runat="server"  ID="admission_date" CausesValidation="true" required="true" placeholder="Enter Admission Date" CssClass="form-control input-sm"  TextMode="Date" />
                                <ajaxToolkit:CalendarExtender runat="server" TargetControlID="admission_date" CssClass="btn btn-primary" Format="dd/MM/yyyy" />

                            </div>
                            <div class="col-sm-2">
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="admission_date" ForeColor="Red" CssClass="form-control input-sm" Display="Dynamic" ErrorMessage="*" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <asp:DropDownList runat="server" ID="admitted_by" CausesValidation="true" CssClass="form-control input-sm" DataSourceID="StaffData" DataTextField="Staff_ID" DataValueField="Staff_ID" >
                                <asp:ListItem Text="Select Staff ID"></asp:ListItem>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ajaxToolkit:CalendarExtender runat="server" TargetControlID="discharge_date" CssClass="btn btn-primary" Format="dd/MM/yyyy" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <asp:DropDownList runat="server" ID="status" CssClass="form-control input-sm ">
                                ...
                                <asp:ListItem Text="On Admission"></asp:ListItem>
                                <asp:ListItem Text="Discharged"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-sm-2">
                ...
                <div class="panel-footer">
                    ...
                    <asp:Button runat="server" ID="cancle" CssClass="btn btn-default" Width="200" Text="Cancel" OnClick="cancle_Click"  />
                </div>
