<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="General_Ward2_Update.aspx.cs" Inherits="LucentTechnologies.Record_Update.General_Ward2_Update" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <ul class="nav nav-tabs"> 
         ...
         <li class="active"><a href="General_Ward2_Update.aspx">General Ward Two</a></li> 
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <a class="btn btn-primary  btn-md disabled glyphicon-forward" href="#"  role="button"> General Ward Two Records </a> 
            ...
            <div class="panel-body">
                ...
                <div class="well well-lg pre-scrollable">
                    ...
                    <asp:ListView ID="ListView1" runat="server" DataSourceID="ward2" DataKeyNames="ID">
                  ...
                  <ajaxToolkit:ConfirmButtonExtender runat="server" ID="con1" TargetControlID="DeleteButton" OnClientCancel="cancelClick" DisplayModalPopupID="ModalPopupExtender1" />
                     ...
                     <strong> You are about to Delete all Records related to this Patient, Once Deleted you cannot undo it.</strong>
                        ...
                        <EditItemTemplate>
                            <tr style="">
                                ...
                                <td>
                                    <asp:TextBox Text='<%# Bind("Admission_Date") %>' runat="server" ID="Admission_DateTextBox" CssClass="form-control input-sm" CausesValidation="true" />
                                    <ajaxToolkit:CalendarExtender runat="server" TargetControlID="Admission_DateTexBox"  CssClass="btn btn-primary"/>
                                ...
                                <td>
                                    <asp:TextBox Text='<%# Bind("Admitted_By") %>' runat="server" ID="Admitted_ByTextBox" CssClass="form-control input-sm" CausesValidation="true" />
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="Admitted_ByTextBox" SetFocusOnError="true" ValidationGroup="group1" />
                                </td>
                                <td>
                                    <asp:TextBox Text='<%# Bind("Ward_Name") %>' runat="server" ID="Ward_NameTextBox" CssClass="form-control input-sm" CausesValidation="true" />
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="Ward_NameTextBox" ValidationGroup="group1" SetFocusOnError="true" />
                                </td>
                                <td>
                                    <asp:TextBox Text='<%# Bind("Bed_Number") %>' runat="server" ID="Bed_NumberTextBox" CssClass="form-control input-sm" TextMode="Number" CausesValidation="true" />
                    ...
                    <asp:SqlDataSource runat="server" ID="ward2" ConnectionString='<%$ ConnectionStrings:Conn %>' DeleteCommand="DELETE FROM [ward_table2] WHERE [ID] = @original_ID" InsertCommand="INSERT INTO [ward_table2] ([ID], [Patient_ID], [Admission_Date], [Admitted_By], [Ward_Name], [Bed_Number], [Discharge_Date], [Status]) VALUES (@ID, @Patient_ID, @Admission_Date, @Admitted_By, @Ward_Name, @Bed_Number, @Discharge_Date, @Status)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [ward_table2]" UpdateCommand="UPDATE [ward_table2] SET [Patient_ID] = @Patient_ID, [Admission_Date] = @Admission_Date, [Admitted_By] = @Admitted_By, [Ward_Name] = @Ward_Name, [Bed_Number] = @Bed_Number, [Discharge_Date] = @Discharge_Date, [Status] = @Status WHERE [ID] = @original_ID">
                        <DeleteParameters>
